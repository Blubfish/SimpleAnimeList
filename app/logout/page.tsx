      ...
      <div className="relative w-full max-w-sm rounded-2xl border border-slate-700/60 bg-slate-900/90 p-8 shadow-2xl shadow-black/60 backdrop-blur-xl">
        ...
        <div className="mt-6 space-y-3">
          <button
            ...
            disabled={isLoading}
            className="w-full rounded-lg bg-linear-to-r from-red-500 to-red-400 py-3 text-xs sm:text-sm font-semibold text-white shadow-lg shadow-red-500/25 transition hover:from-red-400 hover:to-red-300 hover:shadow-red-400/30 disabled:opacity-60"
          >
          ...
          <button
            onClick={() => router.push("/")}
            className="w-full rounded-lg py-2.5 text-xs sm:text-sm font-medium text-slate-400 transition hover:text-slate-200"
          >
            Cancel
          </button>
        </div>
          ...
          <div className="relative w-full max-w-sm rounded-2xl border border-orange-500/40 bg-slate-900/90 p-8 shadow-2xl shadow-black/60 backdrop-blur-xl">
            ...
            <div className="mt-6 space-y-3">
              <a
                ...
                className="block w-full rounded-lg bg-linear-to-r from-orange-500 to-orange-400 py-3 text-center text-xs sm:text-sm font-semibold text-white shadow-lg shadow-orange-500/25 transition hover:from-orange-400 hover:to-orange-300 hover:shadow-orange-400/30"
              >
                Open anilist.co
              </a>
              <button
